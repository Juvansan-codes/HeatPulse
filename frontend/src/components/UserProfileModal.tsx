      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col">
        ...
        <div className="p-6 bg-slate-50 border-b border-slate-200 relative">
          <button
            type="button"
            onClick={onClose}
            className="absolute top-4 right-4 p-1.5 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-200 transition-colors cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>

          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#F47C20] to-orange-600 p-0.5 shadow-md flex items-center justify-center text-white relative">
            ...
            <div>
              ...
              <p className="text-xs text-[#F47C20] font-medium mt-0.5">
                {currentProfile.designation}
              </p>
              <div className="text-[11px] text-slate-500 font-mono mt-1">
                Badge: <span className="text-slate-800 font-semibold">{currentProfile.id}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            <label className="text-slate-500 font-semibold text-[11px] uppercase tracking-wider">
              Switch Operational Role Simulation
            </label>
            <select
              value={selectedRole}
              onChange={(e) => onChangeRole?.(e.target.value)}
              className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-xs rounded-lg px-3 py-2.5 cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#F47C20] font-medium"
            >
          ...
          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-3">
            <div className="flex items-start gap-3">
              <MapPin className="w-4 h-4 text-[#F47C20] shrink-0 mt-0.5" />
              <div>
                <div className="text-slate-500 text-[11px]">Command Jurisdiction</div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-slate-500 text-[11px]">SOP Directive Clearance</div>
                <div className="text-slate-900 font-semibold mt-0.5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-slate-500 text-[11px]">Official Hotline & Duty Desk</div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-slate-500 text-[11px]">Physical Headquarters</div>
                <div className="text-slate-900 mt-0.5">{currentProfile.office}</div>
              </div>
            </div>
          </div>

          {/* Active Session telemetry */}
          <div className="p-3 rounded-lg bg-white border border-slate-200 flex items-center justify-between text-[11px] font-mono text-slate-500">
            <div className="flex items-center gap-2">
        ...
        <div className="px-6 py-3.5 border-t border-slate-200 bg-slate-50 flex items-center justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg text-xs font-semibold bg-[#F47C20] hover:bg-orange-600 text-white shadow-xs transition-colors cursor-pointer"
          >
            Close Dossier
          </button>
        </div>

...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-150">
      <div className="bg-[#0D1527] border border-slate-700/80 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh]">
        {/* Modal Header */}
          ...
          {activeTab === 'display' && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] font-mono text-slate-400">HTSI, UTCI, WBGT</span>
                  </div>
                ...
                <div className="bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] font-mono text-slate-400">Anemometer</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    <button
                      type="button"
              ...
              <div className="bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 space-y-3">
                <span className="font-semibold text-white">GIS Map Workspace Theme</span>
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { id: 'obsidian', label: 'Obsidian Dark', desc: 'Command Center Contrast' },
                    { id: 'satellite', label: 'Dark Satellite', desc: 'Night Radiance Hybrid' },
                    { id: 'topo', label: 'Clean Carto', desc: 'Administrative Grayscale' }
                  ].map((style) => (
                    <button
                      key={style.id}
                      type="button"
              ...
              {/* Display Toggles */}
              <div className="bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 space-y-3">
                <span className="font-semibold text-white">Visual Telemetry Overlays</span>
          ...
          {activeTab === 'alerts' && (
            <div className="space-y-4">
              <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 space-y-3">
                <span className="font-semibold text-white">Municipal Alert Protocol Sound</span>
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    <div className="text-slate-200 font-medium">Audible Severity Warning Chimes</div>
                    <div className="text-[11px] text-slate-400">
              ...
              <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-white">Automated Data Ingestion Refresh</span>
              ...
              <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 space-y-3">
                ...
                <div className="space-y-2 text-[11px] text-slate-400">
                  <div className="flex items-center justify-between p-2 rounded bg-slate-950/60 border border-slate-800/80">
                    <span className="font-medium text-slate-300">Spatial Administrative Base:</span>
                    <span className="font-mono text-emerald-400">200 GCC Wards (2025 boundary)</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-950/60 border border-slate-800/80">
                    <span className="font-medium text-slate-300">Demographic Exposure:</span>
                    <span className="font-mono text-blue-400">WorldPop R2025A 2020 (4.35M pop)</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-950/60 border border-slate-800/80">
                    <span className="font-medium text-slate-300">Health Vulnerability Proxy:</span>
                    <span className="font-mono text-amber-400">140 GCC Health & Wellness Centers</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-950/60 border border-slate-800/80">
                    <span className="font-medium text-slate-300">Thermal Grids:</span>
                    <span className="font-mono text-purple-400">5 Calibrated ERA5-Land Land Cells</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded bg-slate-950/60 border border-slate-800/80">
                    <span className="font-medium text-slate-300">Machine Learning Correction:</span>
                    <span className="font-mono text-emerald-400">XGBoost Lead 1–5 Calibration (-34% MAE)</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-900/80 p-4 rounded-xl border border-slate-800 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2 text-[11px] font-mono">
                  <div className="p-2.5 rounded bg-slate-950 border border-slate-800">
                    ...
                    <div className="text-emerald-400 font-semibold mt-0.5">OPERATIONAL (IST)</div>
                  </div>
                  <div className="p-2.5 rounded bg-slate-950 border border-slate-800">
                    <div className="text-slate-500">CURRENT VERSION</div>
                    <div className="text-blue-400 font-semibold mt-0.5">Phase F1 Application Shell</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Modal Footer */}
        <div className="px-6 py-3.5 border-t border-slate-800 bg-[#0B1120] flex items-center justify-between">
          <button
            type="button"
            onClick={handleReset}
            className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-white px-3 py-1.5 rounded-lg hover:bg-slate-800 transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="px-4 py-1.5 rounded-lg text-xs font-semibold bg-blue-600 hover:bg-blue-500 text-white shadow-md shadow-blue-600/30 flex items-center gap-1.5 transition-all cursor-pointer"
            >
              {isSaved ? (
                <>

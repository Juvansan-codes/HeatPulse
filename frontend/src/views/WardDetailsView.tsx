...
export const WardDetailsView: React.FC<WardDetailsViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-12">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col items-start lg:items-end gap-3 shrink-0">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-600">
              <button
                ...
                className="px-2.5 py-1 rounded-md border border-slate-200 bg-white hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1 transition-colors cursor-pointer"
              >
      ...
      {/* ========================================================================= */}
      {/* 2. CURRENT CONDITIONS (Phase F4 Specification) */}
